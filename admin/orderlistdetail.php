    ...
    <div class="container">
        ...
        if ($result) { ?>
                    ...
                    <tr>
                        ...
                        <?php
                            ...
                            foreach ($image_urls as $image_url) {
                               ...
                               echo "<a href='#.php?id=" . $value['id'] . "'><img src='$image_path' width='90' height='120' style='margin-right: 3px'></a>";
            ...
            if ($order_result['status'] == 'Processing') { ?>
               <a href="info_user.php?orderId=<?= $_GET['orderId'] ?>">Xem địa chỉ nhận hàng</a>
