...
<body>
    ...
    <nav>
        <label class="logo1"> 
                ...
                <img src="images/loogo.png" alt="Checkbox icon" height="80px" >
                </a>
        </label>
         ...
         <ul >
            ...
            <a href="allproduct.php">all</a>
       
            
            <li><a href="index.php" class="active">Trang chủ</a></li>
            <li><a href="productList.php">Sản phẩm</a></li>
            <!-- <LI>
                <form action="index.php?timkiem" method="GET ">
                <li><input type="text" name="search" placeholder="Nhập từ khóa"></li>
                <li><button type="submit" name="timkiem" value="Tìm kiếm">Tìm kiếm</button></li>
                </form>
            </LI> -->
            <?php
